...
//--- Call back function array
  ...
  public: void enableWakeInterrupt (void) ;
  public: void clearWakeFlag (void) ;
  public: void setWakeHandler (void (* inWakeHandler) (void)) ;
  ...
  private: void (* mWakeHandler) (void) = NULL ;
